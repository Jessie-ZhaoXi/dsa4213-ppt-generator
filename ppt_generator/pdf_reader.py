...
class PDF_Reader:
  """
  This class is used to read a PDF file and extract text and images from it.
  """
  def __init__(self):
  ...
  def extract_text_and_image(self, image_output_folder: str, client: H2OGPTE) -> None:
  ...
  def parse_description(self, description: str, num_images: int, client: H2OGPTE) -> List[str]:
    """
    This function is used to parse the description of images.
    """
    if num_images > 1:
